...
namespace Eticaret.WebUI.Areas.Admin.Controllers
{
    ...
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,City,Destrict,OpenAddress,IsActive,IsBillingAddress,IsDeliveryAddress,AppUserId")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,City,Destrict,OpenAddress,IsActive,IsBillingAddress,IsDeliveryAddress,AppUserId")] Address address)
        {
            if (id != address.Id)
            {
                return NotFound();
